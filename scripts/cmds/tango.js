...
module.exports = {
  config: {
    ...
    category: "fun",
    guide: {
      en: "{pn} reply to someone's message or tag them to turn them into Tango",
    },
  },
  ...
  onStart: async function ({ event, message, api }) {
    ...
    if (!targetID)
      return message.reply("🦧 Reply to someone's message or mention them to turn them into Tango!");
    ...
    try {
      ...
      // Perfect face placement (adjust if needed)
      const x = 255;
      const y = 32;
