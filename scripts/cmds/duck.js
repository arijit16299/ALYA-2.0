...
module.exports = {
  config: {
    ...
    category: "fun",
    guide: {
      en: "{pn} reply to someone's message or mention them to turn them into a Duck",
    },
  },
  ...
  onStart: async function ({ event, message, api }) {
    ...
    if (!targetID)
      return message.reply("🦆 Reply to someone's message or mention them to turn them into a Duck!");
